...
- [x] Редактирование архивного сет-листа
...
- ✅ Этап 3: Базовая функциональность архива (CRUD операции, модальное окно, имя создателя)

**Текущий этап:** Готов к Этапу 4 (Система групп)
