...
├── sw.js               # Service Worker для PWA (v146)
...
--primary-color: #339af0; /* светлая тема */
--bg-secondary: #1f2937;
--text-primary: #e5e7eb;
--text-secondary: #9ca3af;
/* И многие другие в variables.css */
```

### PWA
- Офлайн режим
- Установка на устройство
- Service Worker кэширование (v348)
